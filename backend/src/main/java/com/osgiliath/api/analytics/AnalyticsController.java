...
public class AnalyticsController {
    ...
    /**
     * Get revenue over time Returns monthly revenue aggregated from paid invoices
     *
    ...
    @Operation(
            ...
            description =
                    "Returns monthly revenue for the specified period. Only includes paid invoices.")
    ...
    /**
     * Get invoice status breakdown Returns count of invoices grouped by status
     *
    ...
    @Operation(
            ...
            description =
                    "Returns the count of invoices grouped by status (DRAFT, SENT, PAID, OVERDUE, CANCELLED)")
    ...
    /**
     * Get top customers by revenue Returns top customers ranked by total revenue from paid invoices
     *
    ...
    @Operation(
            ...
            description =
                    "Returns top customers ranked by total revenue from paid invoices, including invoice count")
