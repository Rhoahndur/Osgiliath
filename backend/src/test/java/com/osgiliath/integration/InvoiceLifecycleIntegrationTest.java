...
/**
 * Integration test for complete invoice lifecycle with new features Tests the full flow from
 * customer creation through invoice payment
 */
...
class InvoiceLifecycleIntegrationTest extends BaseIntegrationTest {
    ...
    void completeInvoiceLifecycleWithAllFeatures() throws Exception {
        ...
        AddLineItemCommand lineItem1 =
                new AddLineItemCommand(invoiceId, "Web Development - 50 hours", "50", "100.00");
        ...
        AddLineItemCommand lineItem2 =
                new AddLineItemCommand(invoiceId, "Server Setup", "1", "500.00");
    ...
    void shouldDeleteDraftInvoice() throws Exception {
        ...
        // Delete invoice
        mockMvc.perform(delete("/api/invoices/" + invoiceId)).andExpect(status().isNoContent());
