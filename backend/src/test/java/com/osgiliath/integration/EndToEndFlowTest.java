 ...
 *
 * <p>Flow: 1. Create customer 2. Create invoice for customer 3. Add line items to invoice 4. Send
 * invoice 5. Make partial payment 6. Make second partial payment 7. Make final payment (invoice
 * becomes PAID)
 */
    ...
    void shouldCompleteFullInvoiceLifecycle() throws Exception {
        ...
        CreateInvoiceCommand createInvoiceCommand =
                new CreateInvoiceCommand(
                        customerId, LocalDate.now(), LocalDate.now().plusDays(30), List.of());
        ...
        AddLineItemCommand lineItem1 =
                new AddLineItemCommand(
                        invoiceId, "Consulting Services - Project Analysis", "40", "150.00");
        ...
        AddLineItemCommand lineItem2 =
                new AddLineItemCommand(invoiceId, "Software Development Services", "60", "200.00");
        ...
        AddLineItemCommand lineItem3 =
                new AddLineItemCommand(invoiceId, "Technical Documentation", "1", "500.00");
        ...
        // ===== STEP 4: Send Invoice =====
        mockMvc.perform(post("/api/invoices/" + invoiceId + "/send")).andExpect(status().isOk());
        ...
        AddLineItemCommand extraItem =
                new AddLineItemCommand(invoiceId, "Extra Service", "1", "100.00");
